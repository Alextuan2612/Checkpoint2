class Stopwatch {
  ...
  formatTime(ms) {
    ...
    if (this.state=="running") {
      this.value += this.delay;//0+100=100,100+100=200,....
    }
    this.display.innerHTML = this.formatTime(this.value);//ms=100
  }
  ...
  start() {
    if (this.state=="paused") {
      ...
      if (!this.interval) {
        var t=this;
        this.interval = setInterval(function(){t.update();}, this.delay);//khai bao update()
      }
    }
  }
